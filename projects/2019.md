...
####About the project
As a start-up in education, we want to innovate and disrupt the world of learning. One of our plans is to tailor learning to the needs of a student by a technique called adaptive learning. This should improve user experience as students can save time by only learning what they still need to learn. Additionally, through adaptive learning, we can provide schools insight on what their students are good at and where they need some extra assistance.
